                ...
                return (
                  <Fragment key={endpoint.id}>
                    <tr
                      ...
                      onKeyDown={(e) => {
                        if (!isExpandable || e.target !== e.currentTarget) return;
                      ...
                      className={`border-b border-border last:border-b-0 ${
                        isExpandable ? 'cursor-pointer hover:bg-muted/30 focus:outline-none focus:bg-muted/30' : ''
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-mono text-xs whitespace-nowrap">{endpoint.path}</td>
